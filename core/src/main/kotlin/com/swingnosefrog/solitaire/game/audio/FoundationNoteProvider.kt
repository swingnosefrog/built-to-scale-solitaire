...
interface FoundationNoteProvider {
    ...
    /**
     * List of size 9 containing asset keys for sounds.
     * First 8 items are the notes used for building the foundation. Last item is the note for a widget assemble.
     */
