...
object GdxAudioReader {
    ...
    class DecodingHandler(
        val sample: DecodingMusicSample, val music: OpenALMusic, val fileChannel: FileChannel,
    ...
    private fun musicToOutputStream(
        music: OpenALMusic,
        outputStream: OutputStream,
        bufferSize: Int = 4096 * 4,
        listener: AudioLoadListener? = null,
    ): Long {
        val audioBytes = ByteArray(bufferSize)
        var currentLength = 0L
    ...
    private fun newDecodingMusic(
        music: OpenALMusic, file: File, bufferSize: Int = 4096 * 8,
        listener: AudioLoadListener? = null,
    ): Pair<DecodingMusicSample, DecodingHandler> {
        file.createNewFile()
