...
class GdxActionSourceImpl(actions: List<InputActions>) : GdxActionSource(actions) {
    ...
    override fun IDigitalInputAction.mapToKeys(): LinkedHashSet<Int> {
        ...
        return when (this) {
            ...
            InputActions.JumpToTopOfStack -> linkedSetOf(Input.Keys.PAGE_UP, Input.Keys.E)
            InputActions.JumpToBottomOfStack -> linkedSetOf(Input.Keys.PAGE_DOWN, Input.Keys.Q)
        }
    }
}